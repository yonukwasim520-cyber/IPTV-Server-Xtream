...
def upload():
    ...
    # Remove old HLS cache
    clear_hls()



    # Clear old stream memory if exists
    ...
    # Stop old ffmpeg processes if exists
    ...
    return jsonify({
        ...
        "message": "Video uploaded and cache cleared",
